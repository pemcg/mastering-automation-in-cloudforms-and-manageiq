...
For the Provisioning Entry Point, navigate to  __ManageIQ/Service/Provisioning/StateMachines/ServiceProvision_Template/CatalogBundleInitialization__ (see <<c34i12>>).
