...
We saw in <<calling-automation-from-the-restful-api>> how external systems can make _incoming_ calls to CloudForms or ManageIQ using the RESTful API, and run Automate instances, perhaps to initiate workflows that we've defined.
