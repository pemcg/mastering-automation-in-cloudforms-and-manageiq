...
Tags are a very powerful feature of ManageIQ. They allow us to add _Smart Management_ capabilities to the objects in the WebUI such as virtual machines, hosts, or clusters; to create tag-related filters; and to group, sort or categorise items by tag.
