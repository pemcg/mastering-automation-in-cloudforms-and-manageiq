...
First we'll copy _ManageIQ/Service/Provisioning/StateMachines/ServiceProvision_Template/default_ into our own Domain, and rename it _EmptyService_. We'll add a *pre5* relationship to a new instance that we'll create, called __/Service/Provisioning/StateMachines/Methods/rename_service__ (see <<c37i6>>).
...
[[c37i7]]
.Service dialog
image::images/ch37_ss7.png[Screenshot,450,align="center"]
...
image::images/ch37_ss8.png[Screenshot,550,align="center"]
